...
DROP TABLE IF EXISTS uploaded_artwork;
CREATE Table uploaded_artwork(artwork_id SERIAL PRIMARY KEY, artwork_name VARCHAR(50), properties JSON, thumbnail text, username VARCHAR(50) NOT NULL REFERENCES users (username) );
